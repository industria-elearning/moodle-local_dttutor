...
$string['debug_force_reindex'] = 'Paksa indeks ulang konteks';
$string['debug_mode'] = 'Mode debug';
$string['debug_mode_desc'] = 'Aktifkan opsi debug di antarmuka chat. Ketika diaktifkan, pengguna akan melihat kontrol debugging tambahan seperti checkbox untuk memaksa indeks ulang.';
