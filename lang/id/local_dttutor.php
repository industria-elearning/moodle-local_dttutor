...
$string['avatar_position_desc'] = 'Pilih sudut tempat tombol chat mengambang Tutor-IA akan ditampilkan. Secara default muncul di sudut kanan bawah.';
...
$string['teacher'] = 'Guru';
$string['teachername_default'] = 'Tutor AI';
$string['teachername_setting'] = 'Nama guru default';
$string['teachername_setting_desc'] = 'Nama default yang digunakan ketika tidak ada guru ditemukan dalam kursus. Akan digunakan di header chat dan dapat direferensikan menggunakan placeholder {teachername}.';
...
$string['welcomesettings'] = 'Pengaturan pesan selamat datang';
