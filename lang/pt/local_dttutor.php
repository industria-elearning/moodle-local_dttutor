...
$string['indexing_failed'] = 'Sincronização falhou';
...
$string['indexing_phase_fetching'] = 'Obtendo dados do curso...';
...
$string['indexing_phase_uploading'] = 'Enviando documentos...';
$string['indexing_progress'] = 'Progresso: {$a}%';
$string['indexing_running'] = 'Sincronização em andamento';
$string['indexing_status'] = 'Status de sincronização';
...
$string['tutor_enable_requires_indexing'] = 'Você deve sincronizar o conteúdo do curso antes de ativar o Tutor IA.';
