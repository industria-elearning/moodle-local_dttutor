...
$string['debug_force_reindex'] = 'Forzar reindexación de contexto';
$string['debug_mode'] = 'Modo debug';
$string['debug_mode_desc'] = 'Habilita opciones de depuración en la interfaz del chat. Cuando está habilitado, los usuarios verán controles de depuración adicionales como el checkbox para forzar reindexación.';
