...
$string['accepted_files_pdf_only'] = 'Solo se aceptan archivos PDF';
...
$string['clear_selection'] = 'Limpiar selección';
...
$string['course_custom_prompt_help'] = 'Este prompt personalizado anula la configuración global solo para este curso. Déjalo vacío para usar el prompt global.';
$string['course_indexing'] = 'Sincronización del Curso';
$string['course_materials'] = 'Materiales del Curso (PDFs)';
$string['course_materials_help'] = 'Sube archivos PDF adicionales que el tutor IA debe consultar al responder preguntas.';
$string['custom_prompt'] = 'Prompt personalizado';
$string['custom_prompt_desc'] = 'Instrucciones personalizadas para controlar el comportamiento del tutor IA. Use este campo para proporcionar pautas específicas, tono o límites de conocimiento para el tutor.';
...
$string['drag_drop_upload'] = 'Arrastra y suelta archivos PDF aquí';
$string['drag_drop_upload_or_browse'] = 'o haz clic para explorar';
$string['drawer_side'] = 'Lado de apertura del panel';
$string['drawer_side_help'] = 'Elige desde qué lado se abrirá el panel de chat. Esto es independiente de la posición del botón del avatar.';
...
$string['enable_tutor_for_course'] = 'Habilitar el Tutor IA para este curso';
...
$string['error_attempt_later'] = 'Ocurrió un error. Por favor, inténtalo más tarde.';
$string['error_cache_unavailable'] = 'El servicio de chat no está disponible temporalmente. Por favor, intenta refrescar la página.';
$string['error_empty_message'] = 'El mensaje no puede estar vacío';
$string['error_establish_sse_connection'] = '[Error] No se pudo establecer la conexión SSE';
$string['error_http_code'] = 'Error HTTP {$a}';
$string['error_insufficient_tokens'] = 'No hay suficientes créditos de IA disponibles para procesar tu solicitud. Por favor contacta al administrador para agregar más créditos y continuar usando el Tutor IA.';
...
$string['error_license_not_allowed'] = 'La licencia de tu sitio no permite acceso al servicio del Tutor IA. Por favor contacta al administrador para verificar el estado de la licencia o actualizar tu plan.';
$string['error_license_not_allowed_short'] = 'Error de Licencia';
$string['error_message_too_long'] = '[Error] El mensaje es muy largo. Máximo 4000 caracteres.';
...
$string['error_unexpected'] = 'Ocurrió un error inesperado. Por favor, inténtalo de nuevo.';
$string['error_unknown'] = 'Ocurrió un error desconocido. Por favor, inténtalo de nuevo.';
...
$string['error_webservice_not_configured_admin_inline'] = 'El webservice del Proveedor de IA Datacurso necesita ser configurado antes de usar el Tutor IA.';
...
$string['indexing_running'] = 'Sincronización en progreso';
...
$string['material_deleted'] = 'Material eliminado exitosamente';
$string['material_uploaded'] = 'Material subido exitosamente';
$string['off_topic_detection_enabled'] = 'Habilitar detección de temas fuera de contexto';
$string['off_topic_detection_enabled_desc'] = 'Cuando está habilitado, el tutor IA detectará y responderá a mensajes fuera de contexto según el nivel de rigurosidad configurado a continuación.';
$string['off_topic_strictness'] = 'Rigurosidad de detección fuera de contexto';
$string['off_topic_strictness_desc'] = 'Controla qué tan rigurosa es la detección de temas fuera de contexto. Permisivo permite más flexibilidad, mientras que estricto enforce conversaciones relacionadas solo con el curso.';
...
$string['or_click_to_browse'] = 'o haz clic para explorar';
...
$string['positiondisplay_corner'] = 'Posición: esquina {$a->preset} | Panel: {$a->drawer}';
$string['positiondisplay_custom'] = 'Posición: X: {$a->x}, Y: {$a->y} | Panel: {$a->drawer}';
...
$string['selectionformat'] = '{$a->lines} {$a->linetext}, {$a->chars} {$a->chartext} seleccionados';
...
$string['tutor_disabled_notice'] = 'El Tutor IA está actualmente deshabilitado para este curso. Los estudiantes no verán la interfaz del chat.';
...
$string['upload_material'] = 'Subir material';
