...
$string['offtopic_detection_enabled'] = 'Habilitar detección de temas fuera de contexto';
$string['offtopic_detection_enabled_desc'] = 'Cuando está habilitado, el tutor IA detectará y responderá a mensajes fuera de contexto según el nivel de rigurosidad configurado a continuación.';
$string['offtopic_strictness'] = 'Rigurosidad de detección fuera de contexto';
$string['offtopic_strictness_desc'] = 'Controla qué tan rigurosa es la detección de temas fuera de contexto. Permisivo permite más flexibilidad, mientras que estricto enforce conversaciones relacionadas solo con el curso.';
$string['offtopic_strictness_moderate'] = 'Moderado';
$string['offtopic_strictness_permissive'] = 'Permisivo';
$string['offtopic_strictness_strict'] = 'Estricto';
