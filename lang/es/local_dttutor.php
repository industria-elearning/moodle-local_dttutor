...
$string['teachername_setting'] = 'Nombre del profesor predeterminado';
$string['teachername_setting_desc'] = 'Nombre predeterminado a usar cuando no se encuentra un profesor en el curso. Se usará en el encabezado del chat y puede ser referenciado usando el marcador {teachername}.';
