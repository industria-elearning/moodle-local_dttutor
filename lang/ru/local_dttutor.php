...
$string['accepted_files_pdf_only'] = 'Принимаются только PDF-файлы';
...
$string['cancel_indexing'] = 'Отменить';
$string['char'] = 'символ';
...
$string['course_custom_prompt'] = 'Пользовательская подсказка для конкретного курса';
$string['course_custom_prompt_help'] = 'Эта пользовательская подсказка переопределяет глобальную настройку только для этого курса. Оставьте пустым для использования глобальной подсказки.';
$string['course_indexing'] = 'Синхронизация курса';
$string['course_materials'] = 'Материалы курса (PDF)';
$string['course_materials_help'] = 'Загрузите дополнительные PDF-файлы, к которым должен обращаться ИИ-репетитор при ответе на вопросы.';
...
$string['drag_drop_upload_or_browse'] = 'или нажмите для просмотра';
...
$string['enable_tutor_for_course'] = 'Включить ИИ-репетитора для этого курса';
$string['enable_tutor_for_course_help'] = 'При включении ИИ-репетитор будет доступен студентам и преподавателям этого курса. Глобальная настройка плагина также должна быть включена.';
...
$string['indexing_failed'] = 'Ошибка синхронизации';
...
$string['or_click_to_browse'] = 'или нажмите для просмотра';
...
$string['restart_indexing'] = 'Повторная синхронизация курса';
...
$string['tutor_disabled_notice'] = 'ИИ-репетитор в настоящее время отключен для этого курса. Студенты не увидят интерфейс чата.';
$string['tutor_status'] = 'Статус ИИ-репетитора';
...
$string['upload_material'] = 'Загрузить материал';
