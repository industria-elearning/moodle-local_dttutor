...
$string['offtopic_detection_enabled'] = 'Включить обнаружение сообщений вне темы';
$string['offtopic_detection_enabled_desc'] = 'При включении AI-репетитор будет обнаруживать и реагировать на сообщения вне темы в соответствии с уровнем строгости, настроенным ниже.';
$string['offtopic_strictness'] = 'Строгость обнаружения вне темы';
$string['offtopic_strictness_desc'] = 'Управляйте строгостью обнаружения тем вне контекста. Разрешительный позволяет больше гибкости, в то время как строгий обеспечивает разговоры, связанные только с курсом.';
$string['offtopic_strictness_moderate'] = 'Умеренный';
$string['offtopic_strictness_permissive'] = 'Разрешительный';
$string['offtopic_strictness_strict'] = 'Строгий';
