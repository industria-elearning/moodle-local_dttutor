...
$string['apitoken'] = 'Токен аутентификации';
$string['apitoken_desc'] = 'Токен аутентификации для API Tutor-IA';
$string['apiurl'] = 'URL API Tutor-IA';
$string['apiurl_desc'] = 'Базовый URL API Tutor-IA (например: https://plugins-ai-dev.datacurso.com)';
...
$string['teachername_default'] = 'AI Репетитор';
$string['teachername_setting'] = 'Имя преподавателя по умолчанию';
$string['teachername_setting_desc'] = 'Имя по умолчанию для использования, когда преподаватель не найден в курсе. Будет использоваться в заголовке чата и может быть указано с помощью заполнителя {teachername}.';
