...
$string['debug_force_reindex'] = 'Forcer la réindexation du contexte';
$string['debug_mode'] = 'Mode débogage';
$string['debug_mode_desc'] = 'Active les options de débogage dans l\'interface de chat. Lorsqu\'il est activé, les utilisateurs verront des contrôles de débogage supplémentaires comme la case à cocher pour forcer la réindexation.';
