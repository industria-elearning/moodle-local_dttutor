...
$string['accepted_files_pdf_only'] = 'Seuls les fichiers PDF sont acceptés';
...
$string['course_custom_prompt'] = 'Invite personnalisée spécifique au cours';
$string['course_custom_prompt_help'] = 'Cette invite personnalisée remplace le paramètre global uniquement pour ce cours. Laissez vide pour utiliser l\'invite globale.';
$string['course_indexing'] = 'Synchronisation du cours';
$string['course_materials'] = 'Matériaux de cours (PDFs)';
$string['course_materials_help'] = 'Téléchargez des fichiers PDF supplémentaires que le tuteur IA doit consulter lors de la réponse aux questions.';
...
$string['drag_drop_upload'] = 'Glisser-déposer des fichiers PDF ici';
$string['drag_drop_upload_or_browse'] = 'ou cliquer pour parcourir';
...
$string['enable_tutor_for_course_help'] = 'Lorsqu\'il est activé, le tuteur IA sera disponible pour les étudiants et les enseignants de ce cours. Le paramètre global du plugin doit également être activé.';
...
$string['error_insufficient_tokens'] = 'Il n\'y a pas suffisamment de crédits IA disponibles pour traiter votre demande. Veuillez contacter votre administrateur pour ajouter plus de crédits afin de continuer à utiliser le Tuteur IA.';
...
$string['error_license_not_allowed'] = 'La licence de votre site ne permet pas l\'accès au service Tuteur IA. Veuillez contacter votre administrateur pour vérifier l\'état de votre licence ou mettre à niveau votre plan.';
...
$string['error_selected_text_too_large'] = 'Le texte sélectionné est trop volumineux. Veuillez sélectionner une partie plus petite.';
...
$string['indexing_failed'] = 'Échec de la synchronisation';
...
$string['indexing_progress'] = 'Progrès: {$a}%';
$string['indexing_running'] = 'Synchronisation en cours';
$string['indexing_status'] = 'État de la synchronisation';
...
$string['or_click_to_browse'] = 'ou cliquer pour parcourir';
...
$string['selected'] = 'sélectionnés';
$string['selection_indicator'] = '{$a} lignes sélectionnées';
$string['selectionformat'] = '{$a->lines} {$a->linetext}, {$a->chars} {$a->chartext} sélectionnés';
...
$string['upload_material'] = 'Télécharger du matériel';
