...
$string['offtopic_detection_enabled'] = 'Activer la détection hors sujet';
$string['offtopic_detection_enabled_desc'] = 'Lorsqu\'activé, le tuteur IA détectera et répondra aux messages hors sujet selon le niveau de rigueur configuré ci-dessous.';
$string['offtopic_strictness'] = 'Rigueur hors sujet';
$string['offtopic_strictness_desc'] = 'Contrôlez la rigueur de la détection hors sujet. Permissif permet plus de flexibilité, tandis que strict impose des conversations liées uniquement au cours.';
$string['offtopic_strictness_moderate'] = 'Modéré';
$string['offtopic_strictness_permissive'] = 'Permissif';
$string['offtopic_strictness_strict'] = 'Strict';
