...
$string['teachername_default'] = 'Tuteur IA';
$string['teachername_setting'] = 'Nom de l\'enseignant par défaut';
$string['teachername_setting_desc'] = 'Nom par défaut à utiliser lorsqu\'aucun enseignant n\'est trouvé dans le cours. Sera utilisé dans l\'en-tête du chat et peut être référencé avec le placeholder {teachername}.';
...
$string['welcomesettings'] = 'Paramètres du message de bienvenue';
