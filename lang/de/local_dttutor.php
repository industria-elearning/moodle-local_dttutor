...
$string['offtopic_detection_enabled'] = 'Off-Topic-Erkennung aktivieren';
$string['offtopic_detection_enabled_desc'] = 'Wenn aktiviert, erkennt der KI-Tutor Off-Topic-Nachrichten und reagiert entsprechend der unten konfigurierten Strenge.';
$string['offtopic_strictness'] = 'Off-Topic-Strenge';
$string['offtopic_strictness_desc'] = 'Kontrollieren Sie, wie streng die Off-Topic-Erkennung ist. Permissiv erlaubt mehr Flexibilität, während streng nur kursbezogene Gespräche erzwingt.';
$string['offtopic_strictness_moderate'] = 'Moderat';
$string['offtopic_strictness_permissive'] = 'Permissiv';
$string['offtopic_strictness_strict'] = 'Streng';
