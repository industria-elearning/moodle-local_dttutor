...
$string['teachername_default'] = 'AI Tutor';
$string['teachername_setting'] = 'Default teacher name';
$string['teachername_setting_desc'] = 'Default name to use when no teacher is found in the course. This will be used in the chat header and can be referenced using the {teachername} placeholder.';
