...
$string['offtopic_detection_enabled'] = 'Enable off-topic detection';
$string['offtopic_detection_enabled_desc'] = 'When enabled, the AI tutor will detect and respond to off-topic messages according to the strictness level configured below.';
$string['offtopic_strictness'] = 'Off-topic strictness';
$string['offtopic_strictness_desc'] = 'Control how strict the off-topic detection is. Permissive allows more flexibility, while strict enforces course-related conversations only.';
$string['offtopic_strictness_moderate'] = 'Moderate';
$string['offtopic_strictness_permissive'] = 'Permissive';
